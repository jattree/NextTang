...
# The FPGA owns the Console USB-A data pins. The host runs at 60 MHz for USB
# full speed, divides internally for low speed, and its keyboard report is
# synchronised before the 3.5 MHz machine domain consumes it.
