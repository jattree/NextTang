# Spec256 common SD loader with DDR3-backed ordinary upper main RAM.
...
set_clock_groups -asynchronous -group [get_clocks {sys_clk}] -group [get_clocks {serial_clock pixel_clock}] -group [get_clocks {clock_28 clock_7 cpu_clock}] -group [get_clocks {memory_clock}] -group [get_clocks {controller_clock}] -group [get_clocks {usb_clock}]
